...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        the index page.
        """
        create_question("This is in the Future", 30)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['questions'], [])
        self.assertContains(response, 'No polls are available.')
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        """
        future_question = create_question(question_text="Future Question in DetailView", days=5)
    ...
    def test_past_question(self):
        ...
        """
        past_question = create_question(question_text="Past Question in DetailView", days=-1)
